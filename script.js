...
// --- Kode Logika Aplikasi Chat (tidak ada perubahan dari versi terakhir) ---
document.addEventListener('DOMContentLoaded', () => {
    ...
    chatForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const errorMessage = `Maaf, terjadi kesalahan: ${error.message}. Pastikan API Key Anda valid dan coba lagi.`;
    ...
    async function getGeminiResponse(prompt, key) {
        // Menggunakan nama model yang benar: gemini-2.5-flash
